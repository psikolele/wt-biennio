    ...
    <main className="portal-shell print:bg-white print:text-black print:p-0">
      ...
      <div className="portal-container max-w-4xl py-10 sm:py-14 print:hidden">
        ...
        <header className="mt-10 mb-12">
          <div className="mb-4">
            <span className="block font-mono text-xs font-bold tracking-[0.14em] text-blue uppercase mb-2.5">
          ...
          <div className="mt-8 flex sm:inline-flex p-1 rounded-full border border-[var(--line)] bg-[var(--surface-soft)]">
            <button
              type="button"
              onClick={() => setActiveTab("card")}
              className={`flex-1 sm:flex-initial min-h-11 px-5 py-2 rounded-full text-xs font-bold tracking-wide text-center transition-colors ${
                activeTab === "card"
            ...
            <button
              ...
              className={`flex-1 sm:flex-initial min-h-11 px-5 py-2 rounded-full text-xs font-bold tracking-wide text-center leading-tight transition-colors ${
                activeTab === "teacher"
                  ? "bg-[#AAA2FF] text-[#100E1F] shadow-sm"
                  : "portal-muted hover:text-ink"
              }`}
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      <span className="block font-mono text-xs portal-muted uppercase mb-1">{step.phase}</span>
