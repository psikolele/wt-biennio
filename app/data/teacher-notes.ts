export const teacherNotes = {
  ...
  dsaStrategies: {
    ...
    disgrafia: "Preferire digitazione, modelli compilabili e risposta orale o registrata quando coerente con il PDP.",
    discalculia: "Usare griglie, colori non esclusivi, calcolatrice e procedure passo-passo; ridurre il carico di memoria di lavoro."
  },
  guides: [
    {
      title: "Guida Docente - Volume 1 (Clippy Cloud)",
      description: "Progettazione didattica per competenze, rubriche, test d'ingresso e soluzioni delle verifiche.",
      href: "/resources/docenti/Guida_Docente_Vol1.pdf"
    },
    {
      title: "Guida Docente - Volume 2 (Clippy Cloud Plus)",
      description: "Programmazione a blocchi (Scratch 3.0), fogli di calcolo avanzati, basi di dati e compiti di realtà.",
      href: "/resources/docenti/Guida_Docente_Vol2.pdf"
    }
  ],
