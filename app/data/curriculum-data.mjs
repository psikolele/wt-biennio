...
const bsmartMaterials = {
  ...
  "1-18": { cta: [{ label: "Scheda Paragrafi (PDF)", href: "/resources/anno1/settimana-18/B3_U1_4_MODALITA_CORRETTE_SPAZIARE PARAGRAFI.pdf" }], materials: ["Computer", "Documento non formattato di prova"] },
  ...
  "1-23": { cta: [{ label: "Scheda Riferimento Misto (PDF)", href: "/resources/anno1/settimana-23/B4_U2_1_RIFERIMENTO MISTO.pdf" }], materials: ["Computer", "Foglio di calcolo con formule e riferimenti"] },
